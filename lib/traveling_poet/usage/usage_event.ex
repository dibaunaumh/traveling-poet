defmodule TravelingPoet.Usage.UsageEvent do
  ...
  @kinds ~w(daily_run daily_run_attempt first_entry_attempt marker_revision_attempt book_compose_attempt book_compose book_pdf_attempt chat_turn image_gen exec tokens)
