...
config :traveling_poet, TravelingPoet.Repo,
  database: Path.expand("../traveling_poet_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :traveling_poet, TravelingPoetWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/traveling_poet_web/router\.ex$",
      ~r"lib/traveling_poet_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :traveling_poet, dev_routes: true
